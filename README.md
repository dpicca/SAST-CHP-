...
Cette ontologie est conçue pour modéliser des lieux culturels et diverses informations à leur sujet, l'avis qu'en ont les utilisateurs et les sentiments qui en découlent, ainsi que les différentes relations entre ces entités. Elle vise à faciliter l'organisation, l'intégration et la recherche d'informations sur les lieux culturels et comment ceux-ci sont perçus par le public.
