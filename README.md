...
Cette ontologie est conçue pour modéliser les lieux culturels, l'avis qu'ont les utilisateurs, ainsi que les diverses relations entre ces entités. Elle vise à faciliter l'organisation, l'intégration et la recherche d'informations sur les lieux culturels à travers des descriptions.
